...
if ($Dynarec -eq 'Enabled' -and $DynarecSmoke -eq 'Enabled') {
    throw '-Dynarec and -DynarecSmoke cannot both be Enabled.'
}
...
& $CMake `
    ...
    "-DVITA_SH2_DYNAREC=$DynarecValue" `
