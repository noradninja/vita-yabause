...
typedef enum {
   ...
   VITA_PROFILE_VDP2_NBG3,
   VITA_PROFILE_VDP2_NBG2,
   VITA_PROFILE_VDP2_NBG1,
   VITA_PROFILE_VDP2_NBG0,
   VITA_PROFILE_VDP2_RBG0,
   VITA_PROFILE_VDP2_BITMAP,
   VITA_PROFILE_VDP2_PATTERN,
   VITA_PROFILE_VDP2_ROTATION,
   VITA_PROFILE_VDP2_LINE_SCROLL,
   VITA_PROFILE_COUNT
} VitaProfileSection;
